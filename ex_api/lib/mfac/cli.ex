...
#   defp insert_agenda_item_data do
#     # Enum.map(1..10, fn _x -> 
...
#     Enum.map(1..10, fn _x -> 
#       first_name = Faker.Name.first_name |> IO.inspect(label: "first_name")
#       last_name = Faker.Name.last_name
#       email = "#{first_name}.#{last_name}@gmail.com"
#       User.registration_changeset(%User{}, %{password: "asdfasdf", email: email, first_name: first_name, last_name: last_name, is_active: true}) |> IO.inspect(label: "changeset")
...
#       "meetings" -> 
#         insert_meeting_data()
#         |> IO.inspect(label: "INSERTED MEETINGS")
#         "All Set, 10 meetings inserted"
#       "agenda_items" -> 
#         insert_agenda_item_data()
#         |> IO.inspect(label: "INSERTED AGENDA_ITEMS")
#         "All Set, 10 agenda inserted"
#       "all" -> 
#         insert_user_data()
#         insert_meeting_data()
#         insert_agenda_item_data()
