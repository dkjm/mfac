defmodule MfacWeb.UserControllerTest do
  use MfacWeb.ConnCase

  alias Mfac.Accounts
  alias Mfac.Accounts.User

  @create_attrs %{first_name: "some first_name", is_active: true, last_name: "some last_name", middle_name: "some middle_name", suffix: "some suffix"}
